...
data class ThumbData(
    ...
    @JsonProperty("first_retrieve")
    val uploadDate: Instant,
    val length: String,
    @JsonProperty("view_counter")
    val views: Long,
    @JsonDeserialize(contentUsing = NndTagDeserializer::class)
    val tags: List<NndTag>,
    val userId: Long? = null,
    @JsonProperty("ch_id")
    val channelId: Long? = null,
    @JsonAlias(value = ["user_nickname", "ch_name"])
