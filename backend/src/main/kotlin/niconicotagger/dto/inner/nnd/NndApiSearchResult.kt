...
data class NndVideoData(
    @JsonProperty("contentId") val id: String,
    @JsonDeserialize(using = UnescapingStringDeserializer::class) val title: String,
    @JsonDeserialize(using = NndTagStringDeserializer::class) val tags: List<String>,
    val userId: Long?,
    val channelId: Long?,
    ...
    @JsonProperty("startTime") val publishedAt: Instant,
